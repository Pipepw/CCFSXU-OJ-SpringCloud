...
public class Problem implements Serializable {
	 ...
	 * 试题的唯一标识符.
	 */
	private long problemId;	//counter
	 ...
	 * 试题名称. 
	 */
	private String problemName;	//title
	 ...
	 */
	@JsonIgnore
	private int timeLimit;	//time
	
	/**
	 * 最大运行内存.
	 */
	@JsonIgnore
	private int memoryLimit;	//memory
	 ...
	 */
	@JsonIgnore
	private String inputFormat;	//input
	
	/**
	 * 输出格式.
	 */
	@JsonIgnore
	private String outputFormat;	//output
