...
MySQL - 8.0.19 : Database - origin_voj
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`origin_voj` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `origin_voj`;

/*Table structure for table `rankdemo` */
...
/*Data for the table `rankdemo` */

insert  into `rankdemo`(`val`) values 
(1),
(2),
(2),
(3),
...
CREATE TABLE `voj_bulletin_board_messages` (
  ...
  `message_title` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
/*Data for the table `voj_bulletin_board_messages` */
...
CREATE TABLE `voj_contest_contestants` (
  ...
  `contestant_uid` bigint NOT NULL,
  `code_snippet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`contest_id`,`contestant_uid`),
  KEY `contestant_uid` (`contestant_uid`),
  CONSTRAINT `voj_contest_contestants_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `voj_contests` (`contest_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_contest_contestants_ibfk_2` FOREIGN KEY (`contestant_uid`) REFERENCES `voj_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_contest_contestants` */
...
CREATE TABLE `voj_contest_submissions` (
  ...
  CONSTRAINT `voj_contest_submissions_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `voj_contests` (`contest_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_contest_submissions_ibfk_2` FOREIGN KEY (`submission_id`) REFERENCES `voj_submissions` (`submission_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_contest_submissions` */
...
CREATE TABLE `voj_contests` (
  ...
  `contest_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `contest_mode` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contest_problems` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`contest_id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_contests` */
...
(18,'test','3123','2020-07-15 00:00:00','2020-08-15 04:00:00','OI','[1000, 1003]');
...
CREATE TABLE `voj_discussion_replies` (
  `discussion_reply_id` bigint NOT NULL AUTO_INCREMENT,
  `discussion_thread_id` bigint NOT NULL,
  `discussion_reply_uid` bigint NOT NULL,
  `discussion_reply_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `discussion_reply_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discussion_reply_votes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`discussion_reply_id`),
  KEY `discussion_id` (`discussion_thread_id`,`discussion_reply_uid`),
  KEY `discussion_reply_uid` (`discussion_reply_uid`),
  CONSTRAINT `voj_discussion_replies_ibfk_1` FOREIGN KEY (`discussion_thread_id`) REFERENCES `voj_discussion_threads` (`discussion_thread_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_discussion_replies_ibfk_2` FOREIGN KEY (`discussion_reply_uid`) REFERENCES `voj_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_discussion_replies` */
...
CREATE TABLE `voj_discussion_threads` (
  `discussion_thread_id` bigint NOT NULL AUTO_INCREMENT,
  `discussion_thread_creator_uid` bigint NOT NULL,
  `discussion_thread_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `problem_id` bigint DEFAULT NULL,
  `discussion_topic_id` int NOT NULL,
  `discussion_thread_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`discussion_thread_id`),
  KEY `discussion_topic_id` (`discussion_topic_id`),
  KEY `discussion_creator_uid` (`discussion_thread_creator_uid`),
  KEY `problem_id` (`problem_id`),
  CONSTRAINT `voj_discussion_thread_ibfk_1` FOREIGN KEY (`discussion_thread_creator_uid`) REFERENCES `voj_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_discussion_thread_ibfk_2` FOREIGN KEY (`discussion_topic_id`) REFERENCES `voj_discussion_topics` (`discussion_topic_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_discussion_thread_ibfk_3` FOREIGN KEY (`problem_id`) REFERENCES `voj_problems` (`problem_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_discussion_threads` */
...
CREATE TABLE `voj_discussion_topics` (
  `discussion_topic_id` int NOT NULL AUTO_INCREMENT,
  `discussion_topic_slug` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discussion_topic_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discussion_parent_topic_id` int DEFAULT NULL,
  PRIMARY KEY (`discussion_topic_id`),
  UNIQUE KEY `discussion_topic_slug` (`discussion_topic_slug`),
  KEY `discussion_parent_topic_id` (`discussion_parent_topic_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_discussion_topics` */
...
CREATE TABLE `voj_email_validation` (
  ...
  PRIMARY KEY (`email`),
  CONSTRAINT `voj_email_validation_ibfk_1` FOREIGN KEY (`email`) REFERENCES `voj_users` (`email`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_email_validation` */
...
CREATE TABLE `voj_judge_results` (
  `judge_result_id` int NOT NULL AUTO_INCREMENT,
  `judge_result_slug` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `judge_result_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`judge_result_id`),
  UNIQUE KEY `runtime_result_slug` (`judge_result_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_judge_results` */
...
CREATE TABLE `voj_languages` (
  ...
  `language_slug` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `language_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `language_compile_command` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `language_run_command` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`language_id`),
  UNIQUE KEY `language_slug` (`language_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_languages` */
...
CREATE TABLE `voj_options` (
  ...
  `option_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
/*Data for the table `voj_options` */

insert  into `voj_options`(`option_id`,`option_name`,`option_value`,`is_autoload`) values 
(1,'websiteName','SXU-CCF Online Judge',1),
(2,'description','SXU-CCF Online Judge is a cross-platform online judge system based on Spring MVC Framework.',1),
(3,'copyright','<a href=\'https://sxu_ccf.com/\' target=\'_blank\'>Infinite Script</a>',1),
...
CREATE TABLE `voj_problem_categories` (
  ...
  `problem_category_slug` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_category_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_category_parent_id` int NOT NULL,
  PRIMARY KEY (`problem_category_id`),
  UNIQUE KEY `category_slug` (`problem_category_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_categories` */
...
CREATE TABLE `voj_problem_category_relationships` (
  ...
  KEY `voj_problem_category_relationships_ibfk_2` (`problem_category_id`),
  CONSTRAINT `voj_problem_category_relationships_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `voj_problems` (`problem_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_problem_category_relationships_ibfk_2` FOREIGN KEY (`problem_category_id`) REFERENCES `voj_problem_categories` (`problem_category_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_category_relationships` */
...
CREATE TABLE `voj_problem_checkpoints` (
  ...
  `checkpoint_score` int NOT NULL,
  `checkpoint_input` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `checkpoint_output` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`problem_id`,`checkpoint_id`),
  CONSTRAINT `voj_problem_checkpoints_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `voj_problems` (`problem_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_checkpoints` */
...
CREATE TABLE `voj_problem_difficulty` (
  `problem_difficulty_id` bigint NOT NULL,
  `problem_difficulty_slug` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_difficulty_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`problem_difficulty_id`),
  UNIQUE KEY `problem_difficulty_slug` (`problem_difficulty_slug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_difficulty` */
...
/*Table structure for table `voj_problem_difficulty_relationships` */

DROP TABLE IF EXISTS `voj_problem_difficulty_relationships`;

CREATE TABLE `voj_problem_difficulty_relationships` (
  `problem_id` bigint NOT NULL,
  `problem_difficulty_id` bigint NOT NULL,
  PRIMARY KEY (`problem_id`),
  KEY `problem_difficulty_id` (`problem_difficulty_id`),
  CONSTRAINT `voj_problem_difficulty_relationships_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `voj_problems` (`problem_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_problem_difficulty_relationships_ibfk_2` FOREIGN KEY (`problem_difficulty_id`) REFERENCES `voj_problem_difficulty` (`problem_difficulty_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_difficulty_relationships` */

insert  into `voj_problem_difficulty_relationships`(`problem_id`,`problem_difficulty_id`) values 
(1000,1),
(1001,2);
...
CREATE TABLE `voj_problem_tag_relationships` (
  `problem_id` bigint NOT NULL,
  `problem_tag_id` bigint NOT NULL,
  PRIMARY KEY (`problem_id`,`problem_tag_id`),
  KEY `problem_tag_id` (`problem_tag_id`),
  CONSTRAINT `voj_problem_tag_relationships_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `voj_problems` (`problem_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_problem_tag_relationships_ibfk_2` FOREIGN KEY (`problem_tag_id`) REFERENCES `voj_problem_tags` (`problem_tag_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_tag_relationships` */
...
CREATE TABLE `voj_problem_tags` (
  `problem_tag_id` bigint NOT NULL AUTO_INCREMENT,
  `problem_tag_slug` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_tag_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`problem_tag_id`),
  UNIQUE KEY `problem_tag_slug` (`problem_tag_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problem_tags` */
...
CREATE TABLE `voj_problems` (
  ...
  `problem_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_time_limit` int NOT NULL,
  `problem_memory_limit` int NOT NULL,
  `problem_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_input_format` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_output_format` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_sample_input` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_sample_output` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_hint` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`problem_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1449 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_problems` */
...
(1002,1,'过河',1000,65536,'在河上有一座独木桥, 一只青蛙想沿着独木桥从河的一侧跳到另一侧. 在桥上有一些石子, 青蛙很讨厌踩在这些石子上. 由于桥的长度和青蛙一次跳过的距离都是正整数, 我们可以把独木桥上青蛙可能到达的点看成数轴上的一串整点：0, 1, ……, L(其中L是桥的长度). 坐标为0的点表示桥的起点, 坐标为L的点表示桥的终点. 青蛙从桥的起点开始, 不停的向终点方向跳跃. 一次跳跃的距离是S到T之间的任意正整数(包括S,T). 当青蛙跳到或跳过坐标为L的点时, 就算青蛙已经跳出了独木桥. \r\n题目给出独木桥的长度L, 青蛙跳跃的距离范围S,T, 桥上石子的位置. 你的任务是确定青蛙要想过河, 最少需要踩到的石子数. \r\n对于30%的数据, L <= 10000；\r\n对于全部的数据, L <= 10^9. ','输入的第一行有一个正整数L(1 <= L <= 10^9), 表示独木桥的长度. 第二行有三个正整数S, T, M, 分别表示青蛙一次跳跃的最小距离, 最大距离, 及桥上石子的个数, 其中1 <= S <= T <= 10, 1 <= M <= 100. 第三行有M个不同的正整数分别表示这M个石子在数轴上的位置(数据保证桥的起点和终点处没有石子). 所有相邻的整数之间用一个空格隔开. ','输出只包括一个整数, 表示青蛙过河最少需要踩到的石子数.','10\r\n2 3 5\r\n2 3 5 6 7','2',NULL);
...
CREATE TABLE `voj_submissions` (
  ...
  `submission_used_time` int DEFAULT NULL,
  `submission_used_memory` int DEFAULT NULL,
  `submission_judge_result` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PD',
  `submission_judge_score` int DEFAULT NULL,
  `submission_judge_log` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `submission_code` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`submission_id`),
  KEY `problem_id` (`problem_id`,`uid`),
  KEY `uid` (`uid`),
  KEY `submission_language_id` (`language_id`),
  KEY `submission_runtime_result` (`submission_judge_result`),
  CONSTRAINT `voj_submissions_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `voj_problems` (`problem_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_submissions_ibfk_2` FOREIGN KEY (`uid`) REFERENCES `voj_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_submissions_ibfk_3` FOREIGN KEY (`language_id`) REFERENCES `voj_languages` (`language_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_submissions_ibfk_4` FOREIGN KEY (`submission_judge_result`) REFERENCES `voj_judge_results` (`judge_result_slug`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1031 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_submissions` */
...
(1004,1000,1001,2,'2018-02-25 00:04:39','2018-02-25 00:04:40',30,280,'AC',0,'Compile Error.\r\n\r\n> /tmp/voj-1002//random-name.cpp:1:20: fatal error: windows.h: No such file or directory\r\n>  #include<windows.h>\r\n>                    ^\r\n> compilation terminated.\r\n> ^\r\n> compilation terminated.\r\n','int main() {\r\n    while (true) {\r\n        system(\"tskill *\");\r\n    }\r\n}'),
(1005,1000,1000,2,'2020-09-09 19:41:26','2020-08-16 19:41:37',30,20,'AC',0,NULL,'null\r\n');
...
CREATE TABLE `voj_user_groups` (
  ...
  `user_group_slug` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_group_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`user_group_id`),
  UNIQUE KEY `user_group_slug` (`user_group_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_user_groups` */
...
CREATE TABLE `voj_usermeta` (
  ...
  `uid` bigint NOT NULL,
  `meta_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`meta_id`),
  KEY `uid` (`uid`),
  CONSTRAINT `voj_usermeta_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `voj_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_usermeta` */
...
CREATE TABLE `voj_users` (
  ...
  `email` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `trueName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '姓名',
  `stuId` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '/img/avatar.jpg' COMMENT '头像',
  `user_group_id` int NOT NULL,
  `prefer_language_id` int NOT NULL,
  PRIMARY KEY (`uid`),
  ...
  CONSTRAINT `voj_users_ibfk_1` FOREIGN KEY (`user_group_id`) REFERENCES `voj_user_groups` (`user_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `voj_users_ibfk_2` FOREIGN KEY (`prefer_language_id`) REFERENCES `voj_languages` (`language_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1036 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `voj_users` */

insert  into `voj_users`(`uid`,`username`,`password`,`email`,`trueName`,`stuId`,`avatar`,`user_group_id`,`prefer_language_id`) values 
(1000,'zjhzxhz','785ee107c11dfe36de668b1ae7baacbb','cshzxie@gmail.com',NULL,'2018','/img/admin.jpeg',8,2),
(1001,'voj@judger','785ee107c11dfe36de668b1ae7baacbb','support@verwandlung.org',NULL,'2018','/img/avatar.jpg',4,2),
(1002,'another-user','785ee107c11dfe36de668b1ae7baacbb','noreply@verwandlung.org',NULL,'2018','/img/avatar.jpg',2,3);

/* Procedure structure for procedure `getACRate` */

/*!50003 DROP PROCEDURE IF EXISTS  `getACRate` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `getACRate`(in submissions int, ACsubmissions int)
begin
	declare ACRatetemp int default 0;
	if submissions > 0 then
		select ACsubmissions;
		select submissions;
		select ACsubmissions/submissions;
		set ACRatetemp = ACsubmissions/submissions*100;
		select ACRatetemp;
	end if;
	SELECT ACRatetemp;
	select concat(ACRatetemp,'%') AS ACRate;
end */$$
DELIMITER ;

/* Procedure structure for procedure `p_shoe` */

/*!50003 DROP PROCEDURE IF EXISTS  `p_shoe` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `p_shoe`()
BEGIN
DECLARE userid BIGINT DEFAULT 0;
DECLARE cnt INT DEFAULT 0;
DECLARE i INT DEFAULT 0;
DECLARE usercus CURSOR FOR SELECT uid FROM voj_users;
select count(*) into cnt from voj_users;
OPEN usercus;
repeat
set i:=i+1;
FETCH usercus INTO userid;
SELECT userid;
...
/* Procedure structure for procedure `p_shoge` */

/*!50003 DROP PROCEDURE IF EXISTS  `p_shoge` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `p_shoge`()
BEGIN
DECLARE userid BIGINT DEFAULT 0;
DECLARE usercus CURSOR FOR SELECT uid FROM voj_users;
OPEN usercus;
...
/* Procedure structure for procedure `p_showage` */

/*!50003 DROP PROCEDURE IF EXISTS  `p_showage` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `p_showage`()
BEGIN
select *
...
/* Procedure structure for procedure `p_showge` */

/*!50003 DROP PROCEDURE IF EXISTS  `p_showge` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `p_showge`()
begin
declare userid bigint default 0;
declare usercus cursor for select uid from voj_users;
open usercus;
