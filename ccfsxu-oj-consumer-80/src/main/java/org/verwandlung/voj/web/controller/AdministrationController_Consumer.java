...
import org.verwandlung.voj.web.service.AdministrationClientService;
...
@RestController
@RequestMapping(value="/consumer/administration")
public class AdministrationController_Consumer {
	/**
	 * 加载系统管理首页.
	...
	public ResponseData indexView(
		...
		return this.administrationClientService
	...
	public @ResponseBody
	ResponseData getNumberOfSubmissionsAction(
            @ApiParam(value = "时间间隔的天数", name = "period", example = "10")
            @RequestParam(value = "period") int period,
            HttpServletRequest request){
		return this.administrationClientService
				.getNumberOfSubmissionsAction(period, request);
	}
	...
	public ResponseData allUsersView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.allUsersView(userGroupSlug, username, pageNumber, request, response);
	}
	...
	public @ResponseBody ResponseData deleteUsersAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.deleteUsersAction(users, request);
	}
	...
	public ResponseData editUserView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.editUserView(userId, request, response);
	}
	...
	public @ResponseBody ResponseData editUserAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.editUserAction(uid, password, email, userGroupSlug, preferLanguageSlug,
						location, website, socialLinks, aboutMe, request);
	}
	...
	public @ResponseBody ResponseData newUserAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.newUserAction(username, password, email, trueName, stuId,
						userGroupSlug, preferLanguageSlug, request);
	}
	...
	public ResponseData allProblemsView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
			.allProblemsView(keyword, problemCategorySlug, problemTagSlug, pageNumber, request, response);
	}
	...
	public @ResponseBody ResponseData deleteProblemsAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.deleteProblemsAction(problems, request);
	}
	...
	public ResponseData newProblemView(
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.newProblemView(request, response);
	}
	...
	public @ResponseBody ResponseData createProblemAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.createProblemAction(problemName, timeLimit, memoryLimit, description, hint,
						inputFormat, outputFormat, inputSample, outputSample, testCases,
						problemCategories, problemTags, isPublic, isExactlyMatch, request);
	}
	...
	public ResponseData importProblemAction(
            ...
            HttpServletRequest request){
            	return this.administrationClientService
						.importProblemAction(file, request);
	}
	...
	public ResponseData editProblemsView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.editProblemsView(problemId, request, response);
	}
	...
	public @ResponseBody ResponseData editProblemAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.editProblemAction(problemId, problemName, timeLimit, memoryLimit, description, hint,
						inputFormat, outputFormat, inputSample, outputSample, testCases,
						problemCategories, problemTags, isPublic, isExactlyMatch, request);
	}
	...
	public ResponseData problemCategoriesView(
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.problemCategoriesView(request, response);
	}
	...
	public @ResponseBody ResponseData createProblemCategoryAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.createProblemCategoryAction(problemCategorySlug, problemCategoryName, parentProblemCategorySlug, request);
	}
	...
	public @ResponseBody ResponseData editProblemCategoryAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.editProblemCategoryAction(problemCategoryId, problemCategorySlug, problemCategoryName, parentProblemCategorySlug, request);
	}
	...
	public @ResponseBody ResponseData deleteProblemCategoryAction(
            ...
            @RequestParam(value = "problemCategories") String problemCategories,
            HttpServletRequest request){
		return this.deleteProblemCategoryAction(problemCategories, request);
	}
	...
	public ResponseData allSubmissionsView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.allSubmissionsView(problemId, username, pageNumber, request, response);
	}
	...
	public @ResponseBody ResponseData deleteSubmissionsAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.deleteSubmissionsAction(submissions, request);
	}
	...
	public @ResponseBody ResponseData restartSubmissionsAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.restartSubmissionsAction(submissions, request);
	}
	...
	public ResponseData editSubmissionView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.editSubmissionView(submissionId, request, response);
	}
	...
	public ResponseData allContestsView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.allContestsView(keyword, pageNumber, request, response);
	}
	...
	public @ResponseBody ResponseData deleteContestsAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.deleteContestsAction(contests, request);
	}
	...
	public ModelAndView newContestView(
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.newContestView(request, response);
	}
...
//	}
	...
	public ResponseData generalSettingsView(
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
			.generalSettingsView(request, response);
	}
	...
	public @ResponseBody ResponseData updateGeneralSettingsAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
			.updateGeneralSettingsAction(websiteName, websiteDescription, copyright, allowUserRegister, icpNumber, policeIcpNumber, googleAnalyticsCode, offensiveWords, request);
	}
	...
	public ResponseData languageSettingsView(
            HttpServletRequest request, HttpServletResponse response){
		return this.administrationClientService
				.languageSettingsView(request, response);
	}
	...
	public @ResponseBody ResponseData updateLanguageSettingsAction(
            ...
            HttpServletRequest request){
		return this.administrationClientService
				.updateLanguageSettingsAction(languages, request);
	}
