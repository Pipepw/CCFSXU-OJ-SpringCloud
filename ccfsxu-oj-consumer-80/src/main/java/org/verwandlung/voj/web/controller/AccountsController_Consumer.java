...
import org.verwandlung.voj.web.service.AccountsClientService;
...
@RestController
@RequestMapping(value="/consumer/accounts")
public class AccountsController_Consumer {
	/**
	 * 显示用户的登录页面.
	...
	public ResponseData loginView(
		...
		return this.accountsClientService
				.loginView(isLogout,request,response);
	}
	...
	ResponseData loginAction(
		...
		return this.accountsClientService
				.loginAction(username, password, isAutoLoginAllowed, request);
	}
	...
	public @ResponseBody ResponseData registerAction(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.registerAction(username, password, email, trueName, stuId, languageSlug, csrfToken, request);
	}
	...
	public ResponseData resetPasswordView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.accountsClientService
				.resetPasswordView(email, token, request, response);
	}
	...
	public @ResponseBody ResponseData forgotPasswordAction(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.forgotPasswordAction(username, email, csrfToken, request);
	}
	...
	public @ResponseBody ResponseData resetPasswordAction(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.resetPasswordAction(email, token, newPassword, confirmPassword, csrfToken, request);
	}
	...
	public ResponseData userView(
            ...
            HttpServletRequest request, HttpServletResponse response){
		return this.accountsClientService
				.userView(userId, request, response);
	}
	...
	public @ResponseBody ResponseData getNumberOfSubmissionsOfUsersAction(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.getNumberOfSubmissionsOfUsersAction(userId, period, request);
	}
	...
	public ResponseData dashboardView(
            HttpServletRequest request, HttpServletResponse response){
		return this.accountsClientService
				.dashboardView(request, response);
	}
	...
	public @ResponseBody ResponseData changePasswordInDashboardAction(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.changePasswordInDashboardAction(oldPassword,newPassword,confirmPassword,request);
	}
	...
	public @ResponseBody ResponseData updateProfileInDashboardAction(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.updateProfileInDashboardAction(email,location,website,socialLinks,aboutMe,request);
	}
	...
	public ResponseData changeAvatar(
            ...
            HttpServletRequest request){
		return this.accountsClientService
				.changeAvatar(file,userId,request);
	}
